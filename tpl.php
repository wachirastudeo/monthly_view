...
if ($this->next_previous_button) {
    ...
    $navigator_html .= '<div class="mec-calendar-header"><h2>' . $this->main->date_i18n('F', $current_month_time) . '</h2></div>';
...
<div id="mec_skin_<?php echo $this->id; ?>"
    class="mec-wrap <?php echo $event_colorskin . ' ' . $this->html_class . ' ' . $set_dark; ?>">
    ...
    <div class="mec-calendar <?php echo $cal_style; ?>">
        ...
        <div class="mec-calendar-side mec-clear">
            ...
            <div class="mec-skin-monthly-view-month-navigator-container">
                <div class="mec-month-navigator"
                    id="mec_month_navigator_<?php echo $this->id; ?>_<?php echo date('Ym', $current_month_time); ?>">
                    <?php echo $navigator_html; ?></div>
            </div>
            <?php else: ?>
            <div class="mec-calendar-header">
                <h2><?php echo $this->main->date_i18n('Y', $current_month_time); ?></h2>
            </div>
            <?php endif; ?>
            ...
            <div class="mec-calendar-table" id="mec_skin_events_<?php echo $this->id; ?>">
                <div class="mec-month-container mec-month-container-selected"
                    id="mec_monthly_view_month_<?php echo $this->id; ?>_<?php echo date('Ym', $current_month_time); ?>"
                    data-month-id="<?php echo date('Ym', $current_month_time); ?>"><?php echo $month_html; ?></div>
            </div>
        </div>
